...
Assumes a local machine with Python ≥ 3.10 and a CUDA-capable GPU. From the repository root:
...
Each YAML config has three sections: `global`, `attacks`, and `detectors`.
